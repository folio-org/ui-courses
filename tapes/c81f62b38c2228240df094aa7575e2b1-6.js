...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okapi-trace", "GET mod-authtoken-2.6.0-SNAPSHOT.73 http://10.36.1.132:9178/coursereserves/departments.. : 202 13538us, GET mod-courses-1.0.6-SNAPSHOT.96 http://10.36.1.132:9157/coursereserves/departments.. : 200 1995us");
  ...
  res.write(new Buffer("AwADqlycqgIAAA==", "base64"));
  res.end();
