...
/**
 * OPTIONS /coursereserves/reserves?expand=*&limit=100&query=(copiedItem.title="seman*" or copiedItem.barcode="seman*" or copiedItem.callNumber="seman*") sortby name
 *
...
module.exports = function (req, res) {
  ...
  res.setHeader("date", "Tue, 28 Jul 2020 11:50:56 GMT");
