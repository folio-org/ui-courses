...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okapi-trace", "GET mod-courses-1.1.3-SNAPSHOT.106 http://10.36.1.253:9149/coursereserves/courses.. : 200 15242us");
  ...
  res.write(new Buffer("AwBPWymqH0IAAA==", "base64"));
  res.end();
