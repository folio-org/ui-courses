...
module.exports = function (req, res) {
  ...
  res.setHeader("date", "Mon, 01 Mar 2021 17:55:42 GMT");
  ...
  res.setHeader("x-okapi-trace", "GET mod-courses-1.1.3-SNAPSHOT.106 http://10.36.1.217:9159/coursereserves/reserves.. : 200 10846us");
  ...
  res.write(new Buffer("AwDSLyswsxQAAA==", "base64"));
  res.end();
