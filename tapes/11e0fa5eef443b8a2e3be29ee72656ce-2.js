...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okapi-trace", "GET mod-courses-1.1.3-SNAPSHOT.106 http://10.36.1.217:9159/coursereserves/courselistings/79702b52-0d7e-48ea-b7ef-a4e74289f000 : 200 4820us");
  ...
  res.write(new Buffer("AwDzUsLrPwUAAA==", "base64"));
  res.end();
