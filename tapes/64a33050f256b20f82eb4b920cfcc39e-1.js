...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okapi-trace", "GET mod-configuration-5.7.0-SNAPSHOT.90 http://10.36.1.253:9136/configurations/entries.. : 200 3789us");

  res.setHeader("x-yakbak-tape", path.basename(__filename, ".js"));

  res.write(new Buffer("H4sIAAAAAAAAAKrmAgAAAP//UlBQSs7PS8tML1ayUojmAgAAAP//", "base64"));
  res.write(new Buffer("itUBiZTklyTmBKUm5xelgIQNdLgAAAAA//9SUCpKLS7NKfHMS8sHilSjKTHQUUpLTE4tATKjY3WUUjIT0/Pyi0syk8ECtVy1AAAAAP//", "base64"));
