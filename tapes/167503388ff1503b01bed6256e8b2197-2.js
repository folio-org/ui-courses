...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okapi-trace", "GET mod-authtoken-2.6.0-SNAPSHOT.73 http://10.36.1.15:9178/coursereserves/courses.. : 202 6839us, GET mod-courses-1.0.6-SNAPSHOT.96 http://10.36.1.15:9157/coursereserves/courses.. : 200 16693us");
  ...
  res.write(new Buffer("AwCr/YJJ/wkAAA==", "base64"));
  res.end();
