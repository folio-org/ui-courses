...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okapi-trace", "GET mod-authtoken-2.6.0-SNAPSHOT.73 http://10.36.1.15:9178/coursereserves/courses.. : 202 8957us, GET mod-courses-1.0.6-SNAPSHOT.96 http://10.36.1.15:9157/coursereserves/courses.. : 200 97584us");
  ...
  res.write(new Buffer("AwBM+3tQIDgAAA==", "base64"));
  res.end();
