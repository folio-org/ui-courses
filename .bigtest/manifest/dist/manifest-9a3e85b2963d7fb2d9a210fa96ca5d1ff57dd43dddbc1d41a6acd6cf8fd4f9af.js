(function (global, factory) {
    ...
    var require$$0 = index.test('Basic Test').step('visit /', function () {
      return App.visit('/');
    }).child('Logging in', function (test) {
      return test.step('enter username', function () {
        return Input('username').type('diku_admin');
      }).assertion('username has value', function () {
        return Input('username').has({
          value: 'diku_admin'
        });
      });
    });
...
//# sourceMappingURL=manifest-9a3e85b2963d7fb2d9a210fa96ca5d1ff57dd43dddbc1d41a6acd6cf8fd4f9af.js.map