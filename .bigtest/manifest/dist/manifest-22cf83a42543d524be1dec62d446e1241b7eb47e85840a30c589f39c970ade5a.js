(function (global, factory) {
    ...
    var Input = createInteractor('Input')({
      ...
      actions: {
        type: function type(elem, val) {
          ...
          var kev = new KeyboardEvent('keyup', {
            bubbles: true
          });
          elem.dispatchEvent(kev);
        },
    ...
    var require$$0 = index.test('Basic Test').step('increase timeout', /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
      ...
      return test.step('focus input', function () {
        return Input('username').focus();
      }).step('enter username', function () {
...
//# sourceMappingURL=manifest-22cf83a42543d524be1dec62d446e1241b7eb47e85840a30c589f39c970ade5a.js.map